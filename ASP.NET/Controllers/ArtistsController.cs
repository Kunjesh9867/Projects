...
namespace GroovyGoods.Controllers
{
    ...
    public class ArtistsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Genre,Website,YearsActive,DateOfBirth")] Artist artist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Genre,Website,YearsActive,DateOfBirth")] Artist artist)
        {
            if (id != artist.Id)
            {
                return NotFound();
